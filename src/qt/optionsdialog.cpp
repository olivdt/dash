    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NEWCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("NEWCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("NEWCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NEWCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NEWCOIN-traditional"), QVariant("trad"));
