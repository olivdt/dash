    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NewCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NewCoin Core"));
...
All the NewCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NEWCOIN, 0.1 NEWCOIN, 1 NEWCOIN and 10 NEWCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://newcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://newcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NewCoin Core is shutting down...") + "<br /><br />" +
