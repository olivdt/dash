    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NewCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and newcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About NewCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about NewCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NewCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a newcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NewCoin Core help message to get a list with possible NewCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NewCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("NewCoin Core"); // default title
