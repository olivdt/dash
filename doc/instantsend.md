...
This mechanism has been integrated into Bitcore-Node-NewCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/newcoinpay/insight-api-newcoin#web-socket-api](https://github.com/newcoinpay/insight-api-newcoin#web-socket-api)
* API: [https://github.com/newcoinpay/insight-api-newcoin#instantsend-transactions](https://github.com/newcoinpay/insight-api-newcoin#instantsend-transactions)
...
By default, the NewCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NewCoin Core daemon:
