...
NewCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19284.
...
However, in open source software such as NewCoin Core, where everyone uses
...
pay attention to for reviewers of NewCoin Core code.

General NewCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: NewCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
